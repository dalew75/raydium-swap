...
async function loadRaydium(passePoolKeys: LiquidityPoolKeys) {
...
const swap = async (poolInfo: LiquidityPoolKeys, tokenMint: string, baseMint: string, tokenAAmount: number) => {
...
(async () => {
  ...
  if (quoteMint && tokenAAmountString) {
    ...
    if (accountInfo && accountInfo.data.length > 0) {
      ...
      loadRaydium(poolKeys);
      swap(poolKeys, quoteMint, 'So11111111111111111111111111111111111111112', parseFloat(tokenAAmountString));
